...
class Sendbox extends Base{
	...
	public function email() {
		...
		if($count) {
			...
			$this->data["emaillist"]  = DB::getDB()->join("notify_sender","notify_content",$jpara,
																array("a"=>"contentid,receiver,addtime","b"=>"subject"),$where,
	...
	public function sms() {
		...
		if($count) {
			...
			$this->data["smslist"]  = DB::getDB()->join("notify_sender","notify_content",$jpara,
															array("a"=>"contentid,receiver,addtime","b"=>"content"),$where,
															array("a"=>"contentid DESC"),
															$this->data['pagearr']['limit']);
		}
