...
class Gift extends Base{
	...
	public function index() {
		...
		if($count) {
			...
			$this->data["gifts"]   = DB::getDB()->join("gifts","item",$para,$fields,$where,$orderby,
	...
	public function order() {
		...
		if($count) {
		   ...
		   $this->data["pagearr"] = getPageArr($page,$pagesize,$count);
		   //查询数据
		   $this->data["records"]   = DB::getDB()->join("trade_promotion","item",$onarr,
										array("a"=>"*","b"=>"itemimg,itemname"),
										array("a"=>$where),
